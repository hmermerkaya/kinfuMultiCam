...
#ifndef KINFU_INCLUDE_KINFU_GPU_CYCLICAL_BUFFER_H_
#define KINFU_INCLUDE_KINFU_GPU_CYCLICAL_BUFFER_H_
...
#include <gpu/point_intensity.h>
#include <gpu/device_array.h>

//#include <gpu/world_model.h>
...
*/
       ...
       //   pcl::kinfuLS::WorldModel<pcl::PointXYZI> world_model_;
          ...
          void shiftOrigin (TsdfVolume::Ptr tsdf_volume, const int offset_x, const int offset_y, const int offset_z)
          {
           ...
           std::cout<<"offset_x1: "<<offset_x<<std::endl;
           ...
           std::cout<<"offset_x2: "<<offset_x<<std::endl;
...
#endif /* KINFU_INCLUDE_KINFU_GPU_CYCLICAL_BUFFER_H_ */
