...
#ifndef KINFU_INCLUDE_TEXTURE_MAPPING_H_
#define KINFU_INCLUDE_TEXTURE_MAPPING_H_
...
namespace kinfu
{
  ...
  class TextureMapping
  {
    public:
      ...
      typedef kinfu::texture_mapping::Camera Camera;
      typedef kinfu::texture_mapping::UvIndex UvIndex;
      ...
      void
	  setColorsMap( std::vector<boost::shared_ptr<cv::Mat> > & colorsMap) {
    	  colorsMap_=colorsMap;


      };

      void openFileForTitting(const std::string &filename){
    	  if ( filestr.is_open()){
	  ...
	  /** \brief Map texture to a mesh synthesis algorithm
	         ...
	         */
      void
      mapTexture2Mesh (kinfu::TextureMesh &tex_mesh);

      /** \brief Map texture to a mesh UV mapping
        * \param[in] tex_mesh texture mesh
        */
      void
      mapTexture2MeshUV (kinfu::TextureMesh &tex_mesh);
      ...
      /** \brief Map textures acquired from a set of cameras onto a mesh.
        ...
        */
      void
      mapMultipleTexturesToMeshUV (kinfu::TextureMesh &tex_mesh,
                                   kinfu::texture_mapping::CameraVector &cams);
      ...
      /** \brief Remove occluded points from a textureMesh
        ...
        */
      void
      removeOccludedPoints (const kinfu::TextureMesh &tex_mesh, kinfu::TextureMesh &cleaned_mesh, const double octree_voxel_size);
      ...
      /** \brief Remove occluded points from a textureMesh
        ...
        */
      void
      removeOccludedPoints (const kinfu::TextureMesh &tex_mesh, PointCloudPtr &filtered_cloud, const double octree_voxel_size);
      ...
      /** \brief Segment faces by camera visibility. Point-based segmentation.
        ...
        */
      int
      sortFacesByCamera (kinfu::TextureMesh &tex_mesh,
                         kinfu::TextureMesh &sorted_mesh,
                         const kinfu::texture_mapping::CameraVector &cameras,
      ...
      /** \brief Colors the point cloud of a Mesh, depending on its occlusions.
        ...
        */
      void
      showOcclusions (kinfu::TextureMesh &tex_mesh,
                      pcl::PointCloud<pcl::PointXYZI>::Ptr &colored_cloud,
	  ...
	  void
	  textureMeshwithMultipleCameras (kinfu::TextureMesh &mesh,
									  const kinfu::texture_mapping::CameraVector &cameras);
...
#endif /* KINFU_INCLUDE_TEXTURE_MAPPING_H_ */
